...
function save_options() {
  var settings = [ document.getElementById("xbmc_vimeo_path").value, document.getElementById("xbmc_vimeo_host").value, document.getElementById("xbmc_autoplay").checked];
...
function restore_options() {
    if (xbmc_host) {
		document.getElementById("xbmc_vimeo_host").value = xbmc_host;
    } else {
                document.getElementById("xbmc_vimeo_host").value = "username:password@localhost:8080";
    }
    if (xbmc_path) {
		document.getElementById("xbmc_vimeo_path").value = xbmc_path;
    } else {
                document.getElementById("xbmc_vimeo_path").value = "plugin.video.vimeo";
    }
    if (xbmc_autoplay) {
